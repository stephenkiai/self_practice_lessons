#include <stdio.h>
typedef struct myPld //create your structure and its members
{
	char myName[10];
...
int main()
{
  pld s1= {"Winnie", 25472234,70.55,'B'};  // Create a structure variable of myStructure called s1

  pld s2= {"Lorna", 25472454,89.55,'A'};

  pld s3= {"Njenga", 254776564,60.55,'C'};
